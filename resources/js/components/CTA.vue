<template>
    <div class="w-full flex justify-center py-12">
        <router-link :to="{name: 'products'}" 
            class="bg-primary-dark flex justify-between items-center px-6 py-3 w-full sm:w-1/2 md:w-1/3 text-white hover:bg-primary-default rounded-sm">
            <span class="text-xl font-medium leading-5 ">Check out products</span>
